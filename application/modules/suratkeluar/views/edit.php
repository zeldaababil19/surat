              ...
              <form method="post" action="<?php echo base_url(); ?>suratkeluar/update">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $suratkeluar->inisial_pt ?>" class="form-control" id="pt" name="pt" placeholder="Enter Perusahaan" required>
                  </div>
                  <div class="form-group">
                    <label for="jenis_surat">Jenis Surat Keluar</label>
                    <input type="text" value="<?php echo $suratkeluar->nama_kodesurat ?>" class="form-control" id="jenis_surat" name="jenis_surat" placeholder="Enter Jenis Surat" required>
                  </div>
                  <div class="form-group">
                    <label for="instansi">Instansi</label>
                    <input type="text" value="<?php echo $suratkeluar->inisial_instansi ?>" class="form-control" id="instansi" name="instansi" placeholder="Enter Instansi" required>
                  </div>
                  <div class="form-group">
                    <label for="bulan">Bulan</label>
                    <input type="text" value="<?php echo $suratkeluar->bulan_romawi ?>" class="form-control" id="bulan" name="bulan" placeholder="Enter Bulan" required>
                  </div>
                  <div class="form-group">
                    <label for="tahun">Tahun</label>
                    <input type="text" value="<?php echo $suratkeluar->tahun ?>" class="form-control" id="tahun" name="tahun" placeholder="Enter Tahun" required>
                  </div>
