              ...
              <form method="post" action="<?php echo base_url(); ?>project/update">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $project->tahun ?>" class="form-control" id="tahun" name="tahun" placeholder="Enter Tahun" required>
                  </div>
                  <div class="form-group">
                    <label for="keterangan">Keterangan</label>
                    <input type="text" value="<?php echo $project->keterangan ?? '' ?>" class="form-control" id="keterangan" name="keterangan" placeholder="" required>
                  </div>
                </div>
                <!-- /.card-body -->
