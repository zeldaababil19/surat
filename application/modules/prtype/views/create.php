        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="card card-primary">
              ...
              ?>
              <form method="post" action="<?php echo base_url(); ?>prtype/save">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nama_prtype">Nama PR Type</label>
                    <input type="text" class="form-control" id="nama_prtype" name="nama_prtype" placeholder="Enter PR Type" required>
                  </div>
                  <div class="form-group">
